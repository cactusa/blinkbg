...
$email_send_to = 'blinkbg@mail.bg';
// edit your domain
$email_recived_from = 'blinkbg.com';
...
$success_msj = 'Вашето съобщение е изпратено.';
// edit error message
//$error_msj = 'Ups, There has been an error. Please try again in a few minutes';
$error_msj = 'Неизправност в системата. Моля опитайте отново.';
...
<p>
<span style="font-size:20px;font-weight:bold;color:#CC6600;font-family:arial;line-height:110%;">Съобщение изпратено от blinkBG:</span><br>
<span style="font-size:11px;font-weight:normal;color:#999999;font-family:arial;line-height:150%;">
	<br />Име: '.$fname.'
	<br />Фамилия: '.$lname.'
	<br />Email: '.$email.'
	<br />Тема: '.$subject.'
	<br />Съобщение: '.$message.'
</span></td>
</tr>
<tr>
